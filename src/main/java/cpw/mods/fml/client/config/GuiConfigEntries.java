            ...
            if (configElement != null && configElement.showInGui())
            {
                ...
                else if (configElement.isProperty())
                {
                    if (configElement.isList())
                        ...
                        this.listEntries.add(new BooleanEntry(this.owningScreen, this, (IConfigElement<Boolean>) configElement));
                    else if (configElement.getType() == ConfigGuiType.INTEGER)
                        this.listEntries.add(new IntegerEntry(this.owningScreen, this, (IConfigElement<Integer>) configElement));
                    else if (configElement.getType() == ConfigGuiType.DOUBLE)
                        this.listEntries.add(new DoubleEntry(this.owningScreen, this, (IConfigElement<Double>) configElement));
                    else if (configElement.getType() == ConfigGuiType.COLOR)
                    {
                        if (configElement.getValidValues() != null && configElement.getValidValues().length > 0)
                            this.listEntries.add(new ChatColorEntry(this.owningScreen, this, (IConfigElement<String>) configElement));
                        else
                            this.listEntries.add(new StringEntry(this.owningScreen, this, (IConfigElement<String>) configElement));
                    }
                    ...
                    {
                        if (configElement.getValidValues() != null && configElement.getValidValues().length > 0)
                            this.listEntries.add(new CycleValueEntry(this.owningScreen, this, (IConfigElement<String>) configElement));
                        else
                            this.listEntries.add(new StringEntry(this.owningScreen, this, (IConfigElement<String>) configElement));
                    }
                }
