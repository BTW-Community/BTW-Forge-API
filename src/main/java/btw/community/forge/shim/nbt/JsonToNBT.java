package btw.community.forge.shim.nbt;
    ...
    static class Primitive extends Any
    {
        ...
        public NBTBase func_150489_a()
        {
            try
            {
                ...
                {
                    return new NBTTagDouble(null, Double.parseDouble(this.field_150493_b.substring(0, this.field_150493_b.length() - 1)));
                }
                else if (this.field_150493_b.matches("[-+]?[0-9]*\\.?[0-9]+[f|F]"))
                {
                    return new NBTTagFloat(null, Float.parseFloat(this.field_150493_b.substring(0, this.field_150493_b.length() - 1)));
                }
                else if (this.field_150493_b.matches("[-+]?[0-9]+[b|B]"))
                {
                    return new NBTTagByte(null, Byte.parseByte(this.field_150493_b.substring(0, this.field_150493_b.length() - 1)));
                }
                else if (this.field_150493_b.matches("[-+]?[0-9]+[l|L]"))
                {
                    return new NBTTagLong(null, Long.parseLong(this.field_150493_b.substring(0, this.field_150493_b.length() - 1)));
                }
                else if (this.field_150493_b.matches("[-+]?[0-9]+[s|S]"))
                {
                    return new NBTTagShort(null, Short.parseShort(this.field_150493_b.substring(0, this.field_150493_b.length() - 1)));
                }
                else if (this.field_150493_b.matches("[-+]?[0-9]+"))
                {
                    return new NBTTagInt(null, Integer.parseInt(this.field_150493_b.substring(0, this.field_150493_b.length())));
                }
                else if (this.field_150493_b.matches("[-+]?[0-9]*\\.?[0-9]+"))
                {
                    return new NBTTagDouble(null, Double.parseDouble(this.field_150493_b.substring(0, this.field_150493_b.length())));
                }
                    ...
                    if (this.field_150493_b.startsWith("[") && this.field_150493_b.endsWith("]"))
                    {
                        if (this.field_150493_b.length() > 2)
                        {
                            ...
                            try
                            {
                                if (astring.length <= 1)
                                {
                                    return new NBTTagIntArray(null, new int[] {Integer.parseInt(s.trim())});
                                }
                                else
                                {
                                    ...
                                    return new NBTTagIntArray(null, aint);
                                }
                            }
                            catch (NumberFormatException numberformatexception)
                            {
                                return new NBTTagString(null, this.field_150493_b);
                            }
                        }
                        else
                        {
                            return new NBTTagIntArray(null);
                        }
                    }
                    else
                    {
                ...
                {
                    return new NBTTagByte(null, (byte)(Boolean.parseBoolean(this.field_150493_b) ? 1 : 0));
                }
            }
