...
public abstract class FMLPacket {
    ...
    public abstract void execute(INetworkManager iNetworkManager, FMLNetworkHandler fMLNetworkHandler, NetHandler netHandler, String string);
    ...
    static enum Type {
        ...
        FMLPacket make() {
            try {
                ...
                FMLLog.log((Level)Level.SEVERE, (Throwable)var2, "A bizarre critical error occured during packet encoding");
